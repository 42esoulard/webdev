...
function loadHome() {
  ...
  const presentationText = createElem(
    "p",
    "presentationText",
    "Us Cockatoos harvest all our ingredients ourselves and fly them back in our beaks all the way from our home in the Solomon Islands!"
  );
  homePage.appendChild(presentationText);

  const presentationList = createElem(
    "ul",
    "presentationList",
    "Our cookies are made with"
  );
